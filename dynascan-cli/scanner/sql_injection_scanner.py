            ...
            try:
                ...
                if is_vulnerable(response):
                    vulnerabilities.append({
                        "issue": f"SQL Injection found in parameter '{param_name}'",
                        "payload": payload,
                        "description": f"Injected payload: {payload}",
                        "severity": "High",
                        "evidence": response.text[:500]  # Limit evidence to first 500 characters
                    })
